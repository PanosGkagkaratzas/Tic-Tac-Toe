...
public class Activity11 extends AppCompatActivity implements View.OnClickListener {
    ...
    ImageButton image1, image2, image3, image4, image5, image6, image7, image8, image9, image10, image11, image12, image13, image14, image15, image16,image;
    ...
    private void check_for_win(int i) {
        ...
        if (states[0] == player && states[1] == player && states[2] == player
            ...
            if (player == 1) {
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(Activity11.this).create();
                alertDialog.setTitle("TicTacToe");
                alertDialog.setMessage("Winner is: CPU\nStart new game?");
                alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "Quit",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                Intent intent = new Intent(Activity11.this, MainActivity.class);
    ...
    public void cpu() {
        ...
        if (states[4] != 1 && states[4] != 2) {
            image = (ImageButton) findViewById(R.id.b5);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[4] = 2;
            player = 1;
        } else if (states[0] != 1 && states[0] != 2) {
            image = (ImageButton) findViewById(R.id.b1);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[0] = 2;
            player = 1;
        } else if (states[10] != 1 && states[10] != 2) {
            image = (ImageButton) findViewById(R.id.b11);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[10] = 2;
            player = 1;
        }
        else if (states[6] != 1 && states[6] != 2) {
            image = (ImageButton) findViewById(R.id.b7);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[6] = 2;
            player = 1;
        }else if (states[12] != 1 && states[12] != 2) {
            image = (ImageButton) findViewById(R.id.b13);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[12] = 2;
            player = 1;
        } else if (states[2] != 1 && states[2] != 2) {
            image = (ImageButton) findViewById(R.id.b3);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[2] = 2;
            player = 1;
        } else if (states[8] != 1 && states[8] != 2) {
            image = (ImageButton) findViewById(R.id.b9);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[8] = 2;
            player = 1;
        } else if (states[11] != 1 && states[11] != 2) {
            image = (ImageButton) findViewById(R.id.b12);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[11] = 2;
            player = 1;
        } else if (states[7] != 1 && states[7] != 2) {
            image = (ImageButton) findViewById(R.id.b8);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[7] = 2;
            player = 1;
        }
        else if (states[1] != 1 && states[1] != 2) {
            image = (ImageButton) findViewById(R.id.b2);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[1] = 2;
            player = 1;
        }
        else if (states[15] != 1 && states[15] != 2) {
            image = (ImageButton) findViewById(R.id.b16);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[15] = 2;
            player = 1;
        }else if (states[9] != 1 && states[9] != 2) {
            image = (ImageButton) findViewById(R.id.b10);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[9] = 2;
            player = 1;
        } else if (states[3] != 1 && states[3] != 2) {
            image = (ImageButton) findViewById(R.id.b4);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[3] = 2;
            player = 1;
        } else if (states[5] != 1 && states[5] != 2) {
            image = (ImageButton) findViewById(R.id.b6);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[5] = 2;
            player = 1;
        } else if (states[14] != 1 && states[14] != 2) {
            image = (ImageButton) findViewById(R.id.b15);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[14] = 2;
            player = 1;
        } else if (states[13] != 1 && states[13] != 2) {
            image = (ImageButton) findViewById(R.id.b14);
            image.setImageResource(R.drawable.player2);
            image.setEnabled(false);
            states[13] = 2;
            player = 1;
